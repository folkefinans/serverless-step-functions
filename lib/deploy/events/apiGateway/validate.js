    ...
    _.forEach(this.getAllStateMachines(), (stateMachineName) => {
      ...
      _.forEach(stateMachineObj.events, (event) => {
        if (_.has(event, 'http')) {
          ...
          http.integration = this.getIntegration(http, stateMachineName);
          ...
          if (http.integration === 'AWS' || http.integration === 'HTTP') {
            ...
            if (http.request) {
              ...
              if (!_.isEmpty(_.difference(keys, allowedKeys))) {
                const requestWarningMessage = [
                  ...
                  ` configuration in your function "${stateMachineName}". Only the `,
            ...
            if (http.response) {
              const warningMessage = [
                ...
                ` configuration in your function "${stateMachineName}".`,
